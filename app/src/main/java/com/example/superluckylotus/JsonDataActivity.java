...
public class JsonDataActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAddress=findViewById(R.id.btn_show);
        initView();
    }
    ...
    private void initView() {
        ...
        findViewById(R.id.backtosettting).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.backtosettting:
                Intent intent = new Intent(JsonDataActivity.this,SettingActivity.class);
