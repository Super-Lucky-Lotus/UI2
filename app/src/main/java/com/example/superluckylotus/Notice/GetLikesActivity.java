...
import com.example.superluckylotus.ItemInfo.MsgInfo;
import com.example.superluckylotus.Manager.HttpServer;
import com.example.superluckylotus.Me.SingleUserActivity;
 ...
 * @packageName:com.example.superluckylotus
 * @description: 获取数据库中收到喜欢的列表
 * @data: 2020.07.20 11:00
 **/
...
public class GetLikesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_likes =(ListView) findViewById(R.id.list_likes);
        getData();
        setListeners();
    }
    ...
    private void getData() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                String path = "http://139.219.4.34/newlikelist/";
                ...
                if (!phone.equals("")) {
                    ...
                    Toast.makeText(GetLikesActivity.this, "还没有登录哦，快去登录吧!", Toast.LENGTH_SHORT).show();
                }
            }
        }.start();
        Log.v("GetUsers", "Next");
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case 1:
                        ...
                        adapter = new MyAdapter(Msgs);
                        list_likes.setAdapter(adapter);
                        break;
                }
    ...
    public  class MyAdapter extends BaseAdapter {
        ...
        public MyAdapter(List<MsgInfo> infos) {
            super();
            this.infos = infos;
            inflater = (LayoutInflater) GetLikesActivity.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            user_pic.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = null;
                    intent = new Intent(GetLikesActivity.this, SingleUserActivity.class);
