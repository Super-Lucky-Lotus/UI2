...
//                    startActivity(intent);
        ...
        if (!SDKUtils.isValidFile(EDIT_PICTURE_PATH)
            ...
            new AsyncTask<Integer, Integer, Integer>() {
                ...
                protected void onPreExecute() {
                    m_dlgProgress = ProgressDialog.show(MainActivity.this,
    ...
    public void onVideo(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_addshoot: // 正方形，长方形可切换录制视频，编辑录制后的视频，如果有导出时，导出视频的路径
...
//                        getSdkService().initConfiguration(new ExportConfiguration.Builder().get(), builder.get());
    ...
    private ActivityResultHandler albumExportResultHandler = new ActivityResultHandler() {
        ...
        public void onActivityResult(Context context, int resultCode,
            ...
            if (resultCode == RESULT_OK) {
                ...
                //片尾
                Trailer trailer = new Trailer(SDKUtils.createVideoTrailerImage(MainActivity.this, "秀友", 480, 50, 50), 2f, 0.5f);
                ...
                try {
                    SdkEntry.exportVideo(MainActivity.this, videoConfig, arrMediaListPath, exportPath, watermark, trailer, mExportListener);
                } catch (InvalidArgumentException e) {
                    e.printStackTrace();
                }
            }
    ...
    private class ExportVideoLisenter implements ExportListener {
        ...
        public void onExportStart() {
            ...
            mDialog = new AlertDialog.Builder(MainActivity.this).setView(v)
                    .show();
        ...
        public void onExportEnd(int result) {
            ...
            if (result >= VirtualVideo.RESULT_SUCCESS) {
                ...
                Toast.makeText(MainActivity.this, "导出失败" + result, Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    private ActivityResultHandler ablumQuikResultHandler = new ActivityResultHandler() {
        ...
        public void onActivityResult(Context context, int resultCode,
            ...
            if (resultCode == RESULT_OK) {
                ...
                if (arrMediaListPath.size() > 0) {
                    try {
                        SdkEntry.quik(MainActivity.this, arrMediaListPath, EDIT_REQUEST_CODE);
                    } catch (InvalidArgumentException e) {
                        e.printStackTrace();
                    }
                }
    ...
    private void initCameraShortVideoConfig() {
        ...
        if (configData.enableNewApi) {
            ...
            configData.customApi = MainActivity.this.configData.customApi;
